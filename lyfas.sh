...
function web() {
#安装web云端
rm -rf /var/www/* && cd /var/www && wget -q https://qccx.coding.net/p/fas/d/fas/git/raw/master/fas_web.zip #http://lingyi3.nos-eastchina1.126.net/fas_web.zip #${http}${host}${ly863963860}fas_web.zip
...
Crackauthor="H1d3r";
http=https://
host=qccx.coding.net/public/fas/fas/git/files
ly863963860=master/
logo
}
main
