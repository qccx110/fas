...
void Readme()
{
	...
	printf("----------------------------------------------------------------\n");
	printf("恰饭广告：\n");
	printf("交流QQ群: 812968838 欢迎大佬！  个人博客: blog.daloradius.cn\n");
	printf("免费个人梯子VPN，注册赠送3天10GB流量，不需要安装任何APP(PPTP+L2TP+OpenVPN三种可选)，有需要的请查看博客！\n");
	printf("----------------------------------------------------------------\n");
	printf("2021.09.11优化脚本逻辑问题，重新整理，修复APP编译问题，添加程序安装成功or失败检测，添加系统更新解决大部分搭建失败的问题\n");
	printf("-----------------------同意 请回车继续--------------------------\n");
	char hc11[1];
	gets(hc11);
	GET_IP();
